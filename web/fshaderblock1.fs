          ...
          for(itr_Q14 = 0u; itr_Q14 < (USE_B1_Q14 ? pow2(Q14_strength) : 1u); itr_Q14++ ) {
            ...
            for (itr_Q4 = startQ4; itr_Q4 < endQ4; itr_Q4++) {
              ...
              for(itr_Q9 = startQ9; itr_Q9 < endQ9; itr_Q9++ ) {
                  ...
                  if ( (sigma_Q62 & 0x003f8000u) == 0x003f8000u ) continue;
                  ...
                  if (bit(BB0,6u) != 0u) continue;
                  if (bit(BB0,26u) != 0u) continue;
                  if (bit(BB0,27u) != 0u) continue;
                  if (bit(CC0,26u) != 1u) continue;
                  if (bit(CC0,27u) != 0u) continue;
                  if (bit(DD0,26u) != 0u) continue;
                  if (bit(BB0,32u) != bit(CC0,32u)) continue;
                  if (bit(CC0,32u) != bit(DD0,32u)) continue;
